...
username="cui102@csora"
pword="jupYgBdG"

echo "$1"

declare -a queries=("1.0-0" "1.1-1" "1.2-2" "1.3-3" "1.4-4" "2.0-2" "2.3-6" "2.7-9" "2.10-14" "2.15-17" "3.0-2" "3.3-4" "3.5-6" "3.7-8" "3.9-10" "3.11-12" "4.0-6" "5.0-5" "5.6-7")
